jQuery(function($) {
	...
	$("#elementor-control-default-c579").change(function(){
        var filters = $.map($("#elementor-control-default-c579").toArray(), function(e){
            return $(e).val();
        }).join(".");
        $("div.projects-content").find("div").hide();
        $("div.projects-content").find("div." + filters).show();
    });
});