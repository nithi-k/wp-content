...
class RsAddOnRevealerBase {
	...
	protected function loadClasses() {
		...
		new SrRevealerFront(static::$_PluginTitle);
	...
	public function enqueue_admin_scripts($hook) {
		...
		if($hook === 'toplevel_page_revslider') {
			...
			wp_enqueue_style($_handle, static::$_PluginUrl . 'sr6/assets/css/revolution.addon.revealer.preloaders.css', array(), static::$_Version);
