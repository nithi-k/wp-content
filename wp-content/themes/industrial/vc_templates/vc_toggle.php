		...
		<div class="panel">
		   <div class="panel-heading" role="tab" id="<?php echo esc_attr($el_id); ?>-heading">
		      <h4 class="panel-title small-margin">
		        <a class="<?php echo esc_attr($panel_button_class); ?>" role="button" data-toggle="collapse" href="#<?php echo esc_attr($el_id); ?>-body" aria-expanded="<?php echo esc_attr($open); ?>" aria-controls="<?php echo esc_attr($el_id); ?>-body">
