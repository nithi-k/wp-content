var Merlin = (function($) {
  ...
  function window_loaded() {
    ...
    $(".merlin__button--proceed:not(.merlin__button--closer)").click(function(
      e
    ) {
      e.preventDefault();
  ...
  function ContentManager() {
      ...
      if (
        ...
        if (typeof response.url !== "undefined") {
          ...
          if (response.hash === current_item_hash) {
            ...
            jQuery
              .post(response.url, response, ajax_callback)
              .fail(ajax_callback); // recuurrssionnnnn
          }
    ...
    function find_next() {
      ...
      var $enabled_items = $(
        ".merlin__drawer--import-content__list-item input:checked"
      );
      $items.each(function() {
    ...
    function init_content_import_progress_bar() {
      if (
        !$(".merlin__drawer--import-content__list-item .checkbox-content").is(
          ":checked"
        )
      ) {
        return false;
