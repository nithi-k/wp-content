...
require_once get_template_directory() . '/anps-framework/includes/header-menu.php';
require_once get_template_directory() . '/anps-framework/includes/header-lang-dropdown.php';
/*
...
if (!function_exists('anps_search_menu_form')) {
    function anps_search_menu_form()
    {
        ...
        // Insert the custom view using the function
        $data .= anps_language_dropdown();
